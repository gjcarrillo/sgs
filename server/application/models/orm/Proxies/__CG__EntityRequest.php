...
class Request extends \Entity\Request implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'creationDate', 'comment', 'reunion', 'requestedAmount', 'approvedAmount', 'paidAmount', 'status', 'paymentDue', 'loanType', 'contactNumber', 'contactEmail', 'validationDate', 'registrationDate', 'documents', 'history', 'userOwner', 'additionalDeductions');
    }
