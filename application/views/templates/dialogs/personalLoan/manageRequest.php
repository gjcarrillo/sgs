    ...
    <md-dialog-content ng-if="!loading">
        <div layout layout-xs="column" layout-align="start start">
            <div>
                ...
                <!-- Extra deductions -->
                <div ng-if="model.deductions && model.status == PRE_APPROVED_STRING"
                     layout-align="start start">
                    <md-card class="grayish">
                        <md-card-title>
                            <span class="grey-color"><b>Deducciones adicionales</b></span>
                        </md-card-title>
                        ...
                        <md-table-container>
                            <table md-table>
                                ...
                                <tbody md-body>
                                <tr md-row ng-repeat="(lKey, loan) in model.deductions" ng-if="loan.amount">
                                    <td md-cell>{{loan.descripcion}}</td>
                                    <td md-cell>{{loan.saldo_actual | number:2}}</td>
                                    <td md-cell>{{loan.amount | number:2}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </md-table-container>
