angular
    .module('sgdp')
    .controller('ApplicantHomeController', function ($scope, $cookies, $timeout, Config, Applicant,
        ...
        function DialogController($scope, $mdDialog, fetchId, parentScope, obj, $filter) {
            ...
            $scope.loadAdditionalDeductions = function () {
                if ($scope.model.deduct) {
                    ...
                    Requests.loadAdditionalDeductions(fetchId, null, concept).then(
                        function (deductions) {
            ...
            $scope.confirmOperation = function (ev) {
                Utils.showConfirmDialog(
                    ...
                    Requests.getNewRequestConfirmationMsg(concept, $scope.model.reqAmount),
                    'Sí', 'Cancelar', ev, true
                ).then(
                    function() {
