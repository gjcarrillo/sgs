 ...
 */
angular.module('sgdp.service-config', []).factory('Config', function ($http, $q, Constants) {
    var self = this;
    ...
    self.getStatuses = function () {
        ...
        $http.get(Constants.SERVER_URL + 'ConfigController/getStatuses')
            .then(
            function (response) {
    ...
    self.getLoanTypes = function () {
        var qReq = $q.defer();
        $http.get(Constants.SERVER_URL + 'configController/getLoanTypes').then(
            function (response) {
    ...
    self.getStatusesForConfig = function() {
        var qStatuses = $q.defer();
        $http.get(Constants.SERVER_URL + 'ConfigController/getStatusesForConfig')
            .then(
            function (response) {
                if (response.data.message === "success") {
                    qStatuses.resolve(response.data.statuses);
    ...
    self.saveStatuses = function (statuses) {
        var qStatuses = $q.defer();
        $http.post(Constants.SERVER_URL + 'ConfigController/saveStatuses', {statuses: statuses})
            .then(
            function (response) {
                if (response.data.message === "success") {
                    qStatuses.resolve();
    ...
    self.getCashVoucherPercentage = function () {
        ...
        $http.get(Constants.SERVER_URL + 'ConfigController/getCashVoucherPercentage')
            .then(
            function (response) {
                if (response.data.message === "success") {
    ...
    self.updateReqAmount = function (minAmount, maxAmount) {
        var qReqAmount = $q.defer();
        $http.post(Constants.SERVER_URL + 'ConfigController/setReqAmount',
    ...
    self.getRequestsSpan = function () {
        var qSpan = $q.defer();
        $http.get(Constants.SERVER_URL + 'ConfigController/getRequestsSpan')
            .then(
            function (response) {
                console.log(response);
                if (response.data.message === "success") {
    ...
    self.getRequestsTerms = function () {
        var qTerm = $q.defer();
        $http.get(Constants.SERVER_URL + 'ConfigController/getRequestsTerms')
            .then(
            function (response) {
                console.log(response);
                if (response.data.message === "success") {
    ...
    self.updateRequestsTerms = function (terms) {
        var qTerm = $q.defer();
        $http.post(Constants.SERVER_URL + 'ConfigController/updateRequestsTerms', {terms: terms})
            .then(
            function (response) {
                console.log(response);
                if (response.data.message === "success") {
    ...
    self.updateRequestsSpan = function (span) {
        var qSpan = $q.defer();
        $http.post(Constants.SERVER_URL + 'ConfigController/updateRequestsSpan', {span: span})
            .then(
            function (response) {
                if (response.data.message === "success") {
                    qSpan.resolve();
